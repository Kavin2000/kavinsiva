...
<body>
	...
	<section id="content">
	<img src="src/back.png" width="1000" height="500" style="position:absolute; z-index:-1; margin:0;"/>
	...
	<hr />
	   ...
	   <select name="street" class="cjComboBox" >
			...
			<option value="RELIANCE MALL">RELIANCE MALL </option>
	...
	<input type="text" name="account" placeholder="Card Number" required title="Credit card number" maxlength="14"/> 
	   ...
	   <label>Note: Parking Fees: rs. 30/-</label>
	</fieldset>
	<footer>
